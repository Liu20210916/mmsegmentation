...
model = dict(
    ...
    decode_head=dict(
        ...
        align_corners=False,
        loss_decode=[
            dict(type='CrossEntropyLoss', use_sigmoid=False, loss_weight=0.75, name='ce'),
            dict(type='DiceLoss', loss_weight=0.25, name='dice'),
        ]),
...
work_dir = './work_dirs/remote/sfm_b4_dicece13'